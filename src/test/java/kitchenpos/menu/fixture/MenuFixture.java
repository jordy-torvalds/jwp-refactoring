...
import static kitchenpos.menu.fixture.MenuGroupFixture.메뉴그룹_서브메뉴;
...
public class MenuFixture {
    ...
    public static Menu 메뉴_양념_치킨_한마리 = new Menu(2L, "양념 치킨 한마리", valueOf(18_000), 메뉴그룹_치킨류.getId(), asList(메뉴_상품_양념_치킨));
